...
def filter_and_generate_pdf(file1_path, file2_path, output1_path, output2_path, pdf_output_path):
    ...
    c.drawString(40, y_position, "Presentes no vitruvio mas faltando no sigp:")
    y_position -= line_height

    for matricula in only_in_file2:
...
pdf_output_path = 'resultados/matriculasFaltanndoNoSigp.pdf'
